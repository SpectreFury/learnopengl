...
int main() {
  ...
  data = stbi_load("E:/Programming/learnopengl/Coordinates/src/wall.jpg", &width,
                   &height, &nrChannels, 0);
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    for(int i = 0; i < cubePositions.size(); i++) {
      ...
      model = glm::rotate(model, glm::radians(angle * (float)glfwGetTime()), glm::vec3(1.0f, 0.5f, 0.0f));
